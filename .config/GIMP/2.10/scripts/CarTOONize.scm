...
(define (script-fu-CarTOONize
  ...
  (let* (
	 ...
	 (layer-temp1 (car (gimp-layer-new toon-img width height RGB-IMAGE "temp1"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp2 (car (gimp-layer-new toon-img width height RGB-IMAGE "temp2"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp3 (car (gimp-layer-new toon-img width height RGB-IMAGE "temp3"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp2a (car (gimp-layer-new toon-img width height RGB-IMAGE "temp2a"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp4 (car (gimp-layer-new toon-img width height RGB-IMAGE "temp4"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp5 (car (gimp-layer-new toon-img width height RGB-IMAGE "temp5"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp6 (car (gimp-layer-new toon-img width height RGB-IMAGE "temp6"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp7 (car (gimp-layer-new toon-img width height RGB-IMAGE "temp7"  100 LAYER-MODE-NORMAL-LEGACY)))
 	 (layer-gmic (car (gimp-layer-new toon-img width height RGB-IMAGE "gmic"  100 LAYER-MODE-NORMAL-LEGACY)))
 	 (layer-cartoonize (car (gimp-layer-new img width height RGB-IMAGE "CarTOONize"  100 LAYER-MODE-NORMAL-LEGACY)))
 	 (layer-comic (car (gimp-layer-new img width height RGB-IMAGE "Comic-strip"  100 LAYER-MODE-NORMAL-LEGACY)))
         (cdepth (* 4 cdepth))     
         (isfiltered  FALSE)
      ) 
