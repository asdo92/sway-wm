...
### Installation:
  ...
  * **`Install dependencies:`**
    ...
    * Install the packages necessary for sway to function properly:
      ...
      ```shell
      sudo apt install zsh sway swaylock swaybg swayidle sway-backgrounds lxappearance atril vim \
      ...
      sway-notification-center xwayland brightnessctl iw wpasupplicant upower fzf
      ````
